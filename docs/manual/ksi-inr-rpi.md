...
next_review_due: ""
automated_support:
  - { tool: sentinel, ref: collectors/sentinel/ksi-inr-rpi.kql }
evidence_refs: []
---
...
**Control statement.** Past incidents persistently reviewed for previously unidentified patterns/vulnerabilities.
