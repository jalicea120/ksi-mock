...
next_review_due: ""
automated_support:
  - { tool: defender_policy, ref: collectors/defender_policy/ksi-svc-prr.json }
evidence_refs: []
---

# KSI-SVC-PRR - Preventing Residual Risk

**Family.** KSI-SVC (Service Configuration)

**Control statement.** Residual risk reviewed and removed after changes (Class C required; Class B optional).
