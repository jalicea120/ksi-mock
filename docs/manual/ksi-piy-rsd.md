...
next_review_due: ""
automated_support:
  - { tool: github, ref: collectors/github/ksi-piy-rsd.json }
  - { tool: defender_policy, ref: collectors/defender_policy/ksi-piy-rsd.json }
evidence_refs: []
---
...
**Control statement.** Security/privacy built into the SDLC, aligned to CISA Secure by Design; persistently reviewed.
