...
next_review_due: ""
automated_support:
  - { tool: sentinel, ref: collectors/sentinel/ksi-inr-aar.kql }
evidence_refs: []
---
...
**Control statement.** After-action report produced per incident; lessons learned persistently incorporated.
