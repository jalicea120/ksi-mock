...
**Family.** KSI-PIY (Policy & Inventory)

**Control statement.** Vulnerability disclosure program persistently reviewed for effectiveness.

**Attestation of record.** This indicator is **Manual**: it is established by human review and organizational record, not by an automated collector. This document is the attestation of record. A designated
...
## Evidence reviewed
List the organizational artifacts reviewed (policies, meeting records, training rosters, tickets).
