...
next_review_due: ""
automated_support:
  - { tool: arg, ref: collectors/arg/ksi-svc-rud.kql }
evidence_refs: []
---
...
**Control statement.** Unwanted federal customer data removed promptly on request, incl. backups (Class C required; Class B optional).
