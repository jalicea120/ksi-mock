...
next_review_due: ""
automated_support:
  - { tool: github, ref: collectors/github/ksi-cmt-rvp.json }
evidence_refs: []
---

# KSI-CMT-RVP - Reviewing Change Procedures

**Family.** KSI-CMT (Change Management)

**Control statement.** Documented change-management procedure with a persistent effectiveness review.
