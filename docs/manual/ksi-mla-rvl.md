...
next_review_due: ""
automated_support:
  - { tool: sentinel, ref: collectors/sentinel/ksi-mla-rvl.kql }
evidence_refs: []
---

# KSI-MLA-RVL - Reviewing Logs

**Family.** KSI-MLA (Monitoring, Logging & Auditing)

**Control statement.** Logs persistently reviewed and audited (active detections + documented review).
