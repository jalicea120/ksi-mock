...
next_review_due: ""
automated_support:
  - { tool: defender_policy, ref: collectors/defender_policy/ksi-scr-mit.json }
evidence_refs: []
---

# KSI-SCR-MIT - Mitigating Supply Chain Risk

**Family.** KSI-SCR (Supply Chain Risk)

**Control statement.** Supply chain risks persistently identified, reviewed, and mitigated.
